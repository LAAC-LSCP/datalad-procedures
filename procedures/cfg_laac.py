...
has_public_sibling = int(os.getenv('PUBLIC_DATASET')) == 1
...
public_url = "git@gin.g-node.org:/{}/{}-public.git".format(organization, dataset_name)
...
if has_public_sibling:
    ...
    datalad.api.push(dataset = ds, to = 'public')
...
if has_public_sibling and has_confidential_sibling:
    datalad.api.siblings(
        name = 'origin',
        dataset = ds,
        action = 'configure',
